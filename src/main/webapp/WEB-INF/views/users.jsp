...
<body>
    ...
    <section class="hero is-medium is-pink">
        <div class="hero-body has-text-centered">
            <div class="container">
                <h1 class="title has-text-green">Welcome to Lipstick Store</h1>
                <p class="subtitle has-text-black">Discover your perfect lipstick today!</p>
                <a href="/lipstickproductpage" class="button is-white is-medium">Shop Now</a>
            </div>
        </div>
    </section>
